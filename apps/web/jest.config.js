...
module.exports = {
  ...
  coverageThreshold: {
    ...
    // E15 — Referral & Advocate Engine (new code, held to >= 80%).
    './src/app/features/referral/referral-link.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/referral/referral-stats-format.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/referral/share-templates.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/referral/referral-panel.component.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/referral/referral-cta.component.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/referral/advocate-leaderboard.component.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/referral/advocate-manager.component.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    // E17 — Multi-Channel Impact-Feed (new code, held to >= 80%).
    './src/app/features/donor/feed-card-format.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/donor/channel-pref-format.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/donor/read-streak-format.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/donor/impact-feed.component.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/donor/channel-prefs.component.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/donor/inactivity-reminder.component.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/student/voice-message.helpers.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/student/student-voice.component.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    // E18 — Groups-Engine (new code, held to >= 80%).
    './src/app/features/groups/group-format.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/groups/role-format.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/groups/voting-format.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    ...
    './src/app/features/groups/group-voting.component.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
    },
    './src/app/features/groups/group-chat.component.ts': {
      statements: 80,
      branches: 80,
      functions: 80,
      lines: 80,
